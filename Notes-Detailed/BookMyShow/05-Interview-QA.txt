...
================================================================================
    ...
    │                                                                         │
    │  ✓ Understand the complete booking flow                               │
    │  ✓ Explain race conditions and solutions                             │
    │  ✓ Know Redis locking with Lua scripts                               │
    │  ✓ Discuss database design and indexing                              │
    │  ✓ Handle edge cases (payment failures, timeouts)                    │
    │  ✓ Explain scaling strategies (replicas, sharding)                   │
