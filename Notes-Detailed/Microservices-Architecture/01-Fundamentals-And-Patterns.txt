...
================================================================================
    ...
    │  │                                                                 │  │
    │  │  ✓ Large, complex application with multiple teams              │  │
    │  │  ✓ Need to scale different parts independently                 │  │
    │  │  ✓ Require fault isolation (one failure shouldn't crash all)  │  │
    │  │  ✓ Teams need autonomy to choose tech stack                    │  │
    │  │  ✓ Frequent deployments needed for specific features           │  │
    │  │  ✓ Organization structure supports distributed teams           │  │
    │  │                                                                 │  │
    │  │  ────────────────────────────────────────────────────────────  │  │
    │  │                                                                 │  │
