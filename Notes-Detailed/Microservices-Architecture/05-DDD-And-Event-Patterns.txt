...
│                                                                              │
│  PROS:                                                                       │
│  ✓ Easy to understand the flow (one place)                                 │
│  ✓ Centralized error handling and compensation                             │
│  ✓ Easy to track workflow status                                           │
...
================================================================================
    ...
    │  ✓ Optimize read model for queries (denormalized)                     │
    │  ✓ Optimize write model for business logic (normalized)               │
