...
================================================================================
    ...
    │  ✓ Better fault tolerance (server crash doesn't lose state)          │
    ...
    │                                                                         │
    │  PROS:                                                                  │
    │  ✓ Smaller requests (no repeated context)                             │
    │  ✓ Faster (no token validation, cached session)                       │
    │  ✓ Natural for real-time applications                                 │
    │                                                                         │
    │  CONS:                                                                  │
...
================================================================================
    ...
    │  ✓ Immediate response                                                 │
    │  ✓ Easy error handling                                                │
    │  ✓ Strong consistency (see result immediately)                        │
    │                                                                         │
    │  CONS:                                                                  │
