...
───────────────────────────────────
    ...
    │  │                                                                 │  │
    │  │  ✓ Sequential writes (one page at a time)                     │  │
    │  │  ✓ Pages fill up completely (no waste)                        │  │
    │  │  ✓ Pages cached in memory (recently written)                  │  │
    │  │  ✓ Minimal page splits                                        │  │
    │  │                                                                 │  │
    │  └─────────────────────────────────────────────────────────────────┘  │
    │                                                                         │
...
================================================================================
    ...
    │  │                                                                 │  │
    │  │  Txn A: S-Lock on row 1 ✓                                     │  │
    │  │  Txn B: S-Lock on row 1 ✓ (allowed, both reading)            │  │
...
─────────
    ...
    │  │  ────    ─────────────              ─────────────              │  │
    │  │  T1      BEGIN                      BEGIN                      │  │
    │  │  T2      UPDATE row 1 (X-Lock) ✓    UPDATE row 2 (X-Lock) ✓   │  │
