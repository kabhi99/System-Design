...
================================================================================
    ...
    │  ✓ No state maintained                                                │
    │  ✓ Minimal header overhead (8 bytes vs 20+ TCP)                       │
    │  ✓ No flow/congestion control (can send as fast as possible)         │
...
─────────────
    ...
    │  │  Stream B: [1][2][3][4][5] ✓ continues                       │  │
    │  │  Stream C: [1][2][3][4][5] ✓ continues                       │  │
    │  │                                                                 │  │
    │  └─────────────────────────────────────────────────────────────────┘  │
    │                                                                         │
    │  ────────────────────────────────────────────────────────────────────  │
