...
Kubernetes requires a "flat" network where all pods can reach all pods:
    ...
    │                             │                                          │
    │  REQUIREMENTS:                                                         │
    │  ✓ Pod A (10.0.1.2) can reach Pod D (10.0.2.3) directly              │
    │  ✓ No NAT - Pod D sees source IP as 10.0.1.2                         │
    │  ✓ All pods have routable IPs within cluster                         │
    │                                                                         │
    └─────────────────────────────────────────────────────────────────────────┘
...
A typical Kubernetes cluster has THREE distinct IP ranges:
    ...
    │  Pod IPs:     10.244.0.0/16     ✓ (no overlap)                        │
    │  Service IPs: 10.96.0.0/12      ✓ (no overlap)                        │
    │                                                                         │
    └─────────────────────────────────────────────────────────────────────────┘
