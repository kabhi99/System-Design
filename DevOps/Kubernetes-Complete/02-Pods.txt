...
───────────────────────────────────────────────────────────────────────────────
    ...
    │                                                                         │
    │  PROS:                                                                 │
    │  ✓ Works on any network (no special config needed)                   │
    │  ✓ Nodes just need to reach each other                               │
    │  ✓ Easy to set up                                                    │
    │                                                                         │
    │  CONS:                                                                 │
    ...
    │  ✓ Best performance                                                  │
    │  ✓ Standard networking (BGP is well understood)                     │
    │                                                                         │
    │  CONS:                                                                 │
    ...
    │                                                                         │
    │  PROS:                                                                 │
    │  ✓ Best performance (native cloud networking)                        │
    │  ✓ Pods can be accessed directly from VPC                           │
    │  ✓ Security groups work on pods                                     │
    │  ✓ No encapsulation                                                  │
    │                                                                         │
    │  CONS:                                                                 │
