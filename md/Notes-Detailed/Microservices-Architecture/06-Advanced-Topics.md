...
|                                                                              |
|  Q: What is spec-driven (API-first) development?                             |
|  A: Define API contracts (OpenAPI/Protobuf) before code. Generate stubs,     |
|     client SDKs, mocks, docs, and contract tests from the spec. Enables      |
|     parallel dev, prevents integration surprises, and replaces fragile E2E   |
|     tests with contract tests (Pact). See Fundamentals/08-API-Design for     |
|     full coverage.                                                           |
|                                                                              |
|  Q: Consumer-driven vs provider-driven contracts?                            |
|  A: Provider-driven: provider publishes spec, consumers follow it.           |
|     Consumer-driven: each consumer defines what they need, provider          |
|     verifies all contracts in CI. Consumer-driven catches real breaking      |
|     changes better. Tools: Pact, Spring Cloud Contract.                      |
|                                                                              |
+------------------------------------------------------------------------------+
```
